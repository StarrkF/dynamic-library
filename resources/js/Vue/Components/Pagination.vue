...
<template>
<nav aria-label="Page navigation" class="d-flex gap-3 align-items-baseline mt-3">
    <ul class="pagination">
        ...
        <li class="page-item d-none d-md-block" v-for="page in pageInfo.last_page" :key="page" :class="{ active: page === pageInfo.current_page }">
